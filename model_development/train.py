"""
Training script for weed detection model using MobileNet
"""
...
def main():
    ...
    parser.add_argument('--num-classes', type=int, default=3)  # Updated to 3 classes
    ...
    # Set up device, model, optimizer and criterion
